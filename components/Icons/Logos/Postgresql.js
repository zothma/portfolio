...
const SvgPostgresql = (props) => (
  ...
  >
    <style>
      {
        ".postgresql_svg__B{stroke-linecap:round}.postgresql_svg__C{stroke-linejoin:round}.postgresql_svg__D{stroke-linejoin:miter}.postgresql_svg__E{stroke-width:.716}"
      }
    </style>
    <g fill="none" stroke="#fff">
      ...
      <path
        ...
        stroke="none"
      />
      <g className="postgresql_svg__E">
        <g className="postgresql_svg__B">
          <path
        ...
        <g className="postgresql_svg__C">
          ...
          <path
            ...
            className="postgresql_svg__B"
          />
        </g>
      </g>
      <g fill="#fff" className="postgresql_svg__D">
        <path
      ...
      <path
        ...
        className="postgresql_svg__B postgresql_svg__C postgresql_svg__E"
      />
    </g>
  </svg>
);
