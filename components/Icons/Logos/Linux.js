...
const SvgLinux = (props) => (
  ...
  >
    <style>
      {
        ".Linux_svg__B{color-interpolation-filters:sRGB}.Linux_svg__C{fill-opacity:1}.Linux_svg__D{stroke:none}.Linux_svg__E{fill:#020204}.Linux_svg__F{stroke-linejoin:miter}.Linux_svg__G{stroke-opacity:1}.Linux_svg__H{stroke-width:1}.Linux_svg__I{stroke-linecap:butt}.Linux_svg__J{fill:#7c7c7c}"
      }
    </style>
    <defs>
      <filter
        ...
        y={-0.108}
        height={1.217}
        className="Linux_svg__B"
      >
        <feGaussianBlur stdDeviation={3.924} />
      </filter>
      <filter id="Linux_svg__H" className="Linux_svg__B">
        <feGaussianBlur stdDeviation={2.437} />
      </filter>
      <filter id="Linux_svg__I" className="Linux_svg__B">
      ...
      <filter id="Linux_svg__S" className="Linux_svg__B">
      ...
      <filter id="Linux_svg__c" className="Linux_svg__B">
        <feGaussianBlur stdDeviation={0.785} />
      </filter>
      <filter id="Linux_svg__d" className="Linux_svg__B">
        <feGaussianBlur stdDeviation={1.138} />
      </filter>
      <filter id="Linux_svg__e" className="Linux_svg__B">
      ...
      <filter id="Linux_svg__j" className="Linux_svg__B">
      ...
      <filter id="Linux_svg__m" className="Linux_svg__B">
      ...
      <filter id="Linux_svg__r" className="Linux_svg__B">
      ...
      <filter id="Linux_svg__y" className="Linux_svg__B">
      ...
      <linearGradient id="Linux_svg__C" xlinkHref="#Linux_svg__Ac">
        <stop offset={0} stopColor="#3e2a06" />
        <stop offset={1} stopColor="#ad780a" />
      </linearGradient>
      <linearGradient
        xlinkHref="#Linux_svg__C"
        id="Linux_svg__D"
        x1={447.113}
        y1={364.09}
        x2={489.181}
      ...
      <linearGradient
        ...
        y2={293.585}
      />
      <linearGradient id="Linux_svg__b" xlinkHref="#Linux_svg__Ac">
        <stop offset={0} />
        <stop offset={1} stopOpacity={0.25} />
      </linearGradient>
      <linearGradient id="Linux_svg__l" xlinkHref="#Linux_svg__Ac">
        <stop offset={0} stopColor="#3a2903" />
        <stop offset={0.555} stopColor="#735208" />
        <stop offset={1} stopColor="#ac8c04" />
      </linearGradient>
      <linearGradient id="Linux_svg__q" xlinkHref="#Linux_svg__Ac">
      ...
      <linearGradient id="Linux_svg__Ac" gradientUnits="userSpaceOnUse" />
      <radialGradient
        r={14.572}
        fy={137.661}
        fx={223.196}
        cy={137.661}
        cx={223.196}
        gradientTransform="matrix(1.08578 -.03431 .03944 1.24799 -154.542 -26.543)"
        id="Linux_svg__A"
        xlinkHref="#Linux_svg__Ac"
      >
      ...
      <radialGradient
        ...
        cy={137.661}
        cx={223.196}
        gradientTransform="matrix(.81524 -.03431 .02961 1.24799 -129.437 -26.543)"
        id="Linux_svg__B"
        xlinkHref="#Linux_svg__Ac"
      >
        <stop offset={0} stopColor="#fefefc" />
      ...
      <radialGradient
        id="Linux_svg__AA"
        gradientTransform="matrix(.81524 -.03431 .02961 1.24799 -208.437 -35.543)"
        cx={223.196}
        cy={137.661}
        fx={223.196}
        fy={137.661}
      ...
      <radialGradient
        id="Linux_svg__AB"
        gradientTransform="matrix(1.08578 -.03431 .03944 1.24799 -233.542 -35.543)"
        cx={223.196}
        cy={137.661}
        fx={223.196}
        fy={137.661}
      ...
      <radialGradient
        id="Linux_svg__AC"
        gradientTransform="matrix(.69785 -.50717 .46034 .6334 -271.102 183.03)"
        cx={275.538}
        cy={150.651}
        fx={275.538}
        fy={150.651}
      ...
      <radialGradient
        id="Linux_svg__AI"
        gradientTransform="matrix(.93619 -.3864 .27133 .65739 -244.475 146.723)"
        cx={294.485}
        cy={193.099}
        fx={294.485}
        fy={193.099}
      ...
      <radialGradient
        xlinkHref="#Linux_svg__l"
        id="Linux_svg__AK"
        gradientTransform="matrix(1 0 0 .58333 0 61.416)"
        cx={77.672}
        cy={147.093}
        fx={77.672}
        fy={147.093}
      ...
      <radialGradient
        xlinkHref="#Linux_svg__l"
        id="Linux_svg__AL"
        gradientTransform="matrix(1 0 0 1.07512 0 -11.094)"
        cx={63.125}
        cy={147.441}
        fx={63.125}
        fy={147.441}
      ...
      <radialGradient
        id="Linux_svg__AN"
        gradientTransform="matrix(.20141 -.03316 .03065 .18616 -3.126 114.036)"
        cx={268.07}
        cy={126.535}
        fx={268.07}
        fy={126.535}
      ...
      <radialGradient
        id="Linux_svg__AO"
        gradientTransform="matrix(-.69844 0 0 .76336 166.306 50.22)"
        cx={336.224}
        cy={220.538}
        fx={336.224}
        fy={220.538}
      ...
      <radialGradient
        xlinkHref="#Linux_svg__b"
        id="Linux_svg__AP"
        gradientTransform="matrix(1 0 0 .76336 -289 41.22)"
        cx={312.145}
        cy={236.366}
        fx={312.145}
        fy={236.366}
      ...
      <radialGradient
        xlinkHref="#Linux_svg__b"
        id="Linux_svg__AQ"
        gradientTransform="matrix(1 0 0 1.06923 -289 -23.86)"
        cx={275.554}
        cy={225.135}
        fx={275.554}
        fy={225.135}
      ...
      <radialGradient
        id="Linux_svg__AU"
        gradientTransform="matrix(1.3082 .35053 -.36795 1.37322 -310.51 -240.35)"
        cx={363.34}
        cy={303.415}
        fx={363.34}
        fy={303.415}
      ...
      <radialGradient
        id="Linux_svg__AW"
        gradientTransform="matrix(.36025 .1568 -.07247 .1665 260.617 181.938)"
        cx={382.235}
        cy={246.858}
        fx={382.235}
        fy={246.858}
      ...
      <clipPath id="Linux_svg__F">
        <path
          ...
          fill="#402c07"
          className="Linux_svg__C Linux_svg__D"
        />
      </clipPath>
      <clipPath id="Linux_svg__J">
        <path
          ...
          stroke="#729fcf"
          strokeWidth={0.125}
          className="Linux_svg__F Linux_svg__G"
        />
      </clipPath>
      <clipPath id="Linux_svg__L">
        <path
          ...
          fill="none"
          stroke="#ce5c00"
          className="Linux_svg__F Linux_svg__G Linux_svg__H Linux_svg__I"
        />
      </clipPath>
      <clipPath id="Linux_svg__N">
        <path
          d="M386.188 285.328c-.405-1.104-1.118-2.082-1.99-2.87s-1.9-1.392-2.983-1.852c-2.165-.92-4.52-1.26-6.832-1.696l-6.528-1.277c-2.27-.386-4.618-.632-6.865-.125-1.966.443-3.784 1.46-5.272 2.82s-2.65 3.056-3.485 4.9c-1.472 3.23-1.935 6.865-1.654 10.403.21 2.633.875 5.346 2.61 7.34 1.4 1.61 3.387 2.615 5.434 3.22a18.396 18.396 0 0 0 10.86-.155 28.59 28.59 0 0 0 14.33-10.779c1.14-1.65 2.112-3.448 2.553-5.403.336-1.5.348-3.08-.178-4.515"
          fill="none"
          stroke="#ce5c00"
    ...
    <path
      ...
      fill="url(#Linux_svg__AC)"
      transform="matrix(.10711 0 0 .10711 16.035 -7.175)"
    />
    <path
      transform="matrix(.12342 0 0 .12342 -16.317 -9.622)"
      ...
      filter="url(#Linux_svg__w)"
      className="Linux_svg__J"
    />
    <path
      d="M17.444 5.867c-.112.008-.22.046-.316.107s-.176.14-.24.233a1.206 1.206 0 0 0-.191.636c-.007.169.012.34.067.499s.15.306.28.413a.79.79 0 0 0 .962.044c.114-.078.204-.186.27-.307s.103-.255.12-.392c.032-.24-.003-.492-.114-.707s-.3-.394-.528-.478a.745.745 0 0 0-.31-.047z"
      className="Linux_svg__E"
    />
    <path
      ...
      fill="#141413"
      filter="url(#Linux_svg__u)"
      transform="matrix(.10711 0 0 .10711 -14.921 -8.14)"
    />
    <path
      ...
      fill="url(#Linux_svg__AD)"
      filter="url(#Linux_svg__v)"
      transform="matrix(.10711 0 0 .10711 -14.921 -8.14)"
    />
    <path
      ...
      clipPath="url(#Linux_svg__t)"
      transform="matrix(.10711 0 0 .10711 7.573 -8.14)"
      fill="url(#Linux_svg__AE)"
    />
    <path
      d="M16.406 105.125c-.477.6-.908 1.252-1.25 1.97 2.146.462 4.2 1.346 6.03 2.563 3.545 2.354 6.237 5.796 8.125 9.625a10.04 10.04 0 0 0 1.188-1.594c-1.898-3.988-4.644-7.595-8.312-10.03-1.762-1.17-3.725-2.054-5.78-2.53z"
      fill="url(#Linux_svg__AF)"
      filter="url(#Linux_svg__s)"
      transform="matrix(.10711 0 0 .10711 16.035 -7.175)"
    />
    <path
      d="M-24.97 107.08c-.242-.005-.477.017-.72.028l-.47.028c1.413.128 2.818.508 4.094 1.08 1.74.78 3.274 1.893 4.625 3.16 2.504 2.345 4.365 5.24 5.625 8.31a20.8 20.8 0 0 0-2.062-6.659 21.687 21.687 0 0 0-1.562-1.65c-1.35-1.266-2.886-2.378-4.625-3.16-1.52-.683-3.214-1.108-4.906-1.138z"
      fill="url(#Linux_svg__AG)"
      filter="url(#Linux_svg__r)"
      transform="matrix(.10711 0 0 .10711 16.035 -7.175)"
    />
    <path
      d="M12.922 6.547c-.04.24-.042.493.041.723.054.151.145.288.254.407.072.077.153.147.248.193s.206.065.308.039c.094-.024.177-.085.238-.16s.101-.167.13-.26a1.443 1.443 0 0 0-.013-.848 1.107 1.107 0 0 0-.324-.528c-.077-.064-.166-.115-.263-.138s-.203-.018-.294.024c-.1.045-.179.133-.23.231s-.077.208-.095.317z"
      className="Linux_svg__E"
    />
    <path
      ...
      fill="url(#Linux_svg__AH)"
      filter="url(#Linux_svg__p)"
      transform="matrix(.10711 0 0 .10711 -4.21 -8.14)"
    />
    <g transform="matrix(.10711 0 0 .10711 7.573 -8.14)">
      <path
      ...
      <path
        ...
        fill="#d9b30d"
        filter="url(#Linux_svg__i)"
      />
      <path
        d="m54.066 156.68-3.898 2.563c-.657.466-1.334.97-1.68 1.696-.246.515-.302 1.1-.3 1.67s.03 1.144-.046 1.7c-.05.386-.154.766-.172 1.155-.01.195.005.39.056.58a1.2 1.2 0 0 0 .275.509c.173.183.408.296.65.37s.49.11.736.17c1.175.276 2.197.997 3.094 1.804l2.64 2.476c2.537 2.064 5.9 2.92 9.16 2.973s6.504-.63 9.695-1.35l7.425-2.044c3.703-1.365 7.14-3.432 10.118-6.022 1.35-1.174 2.617-2.464 4.133-3.415 1.34-.842 2.843-1.398 4.206-2.203.122-.072.243-.146.352-.237s.206-.198.27-.325c.11-.22.11-.48.04-.716s-.206-.444-.36-.634a4.384 4.384 0 0 0-.57-.578c-1.424-1.22-3.357-1.662-5.226-1.81s-3.76-.043-5.6-.352c-1.74-.3-3.393-.94-5.072-1.477a37.34 37.34 0 0 0-5.389-1.31c-4.295-.7-8.717-.566-12.977.32a37.928 37.928 0 0 0-11.54 4.48z"
        fill="#604405"
        filter="url(#Linux_svg__j)"
      />
      <path
        d="M53.64 152.154a23.787 23.787 0 0 0-5.136 4.685c-.84 1.03-1.604 2.15-2.027 3.412-.333.992-.446 2.042-.656 3.067-.08.384-.17.77-.17 1.16.001.196.026.393.086.58s.158.362.294.503c.225.234.54.36.858.426s.644.075.966.112c1.455.165 2.794.872 4 1.702l3.554 2.578c2.734 1.73 5.995 2.498 9.227 2.623s6.457-.366 9.63-1c2.52-.503 5.034-1.1 7.425-2.044 3.662-1.444 6.964-3.667 10.118-6.022 1.433-1.07 2.846-2.173 4.133-3.415.437-.422.86-.86 1.328-1.246s.988-.722 1.566-.908c.88-.283 1.836-.202 2.748-.05.687.115 1.376.27 2.072.24.348-.014.697-.074 1.02-.204s.622-.33.843-.6a2.02 2.02 0 0 0 .442-1.272c.002-.458-.14-.91-.37-1.305-.465-.79-1.268-1.323-2.105-1.695-1.146-.51-2.386-.76-3.606-1.056a51.63 51.63 0 0 1-10.836-3.954c-1.716-.852-3.384-1.796-5.072-2.7-1.736-.93-3.505-1.824-5.39-2.395-4.213-1.277-8.82-.858-12.977.586a27.75 27.75 0 0 0-11.966 8.188z"
        fill="url(#Linux_svg__AJ)"
      />
      <path
      ...
      <path
        ...
        opacity={0.8}
        fill="url(#Linux_svg__AK)"
        filter="url(#Linux_svg__m)"
      />
      <path
        d="M63.827 146.47c-.888-.29-2.357 1.277-1.878 2.08.132.22.535.5.806.35.41-.225.744-1.03 1.187-1.345.296-.21.23-.972-.116-1.084z"
        opacity={0.8}
        fill="url(#Linux_svg__AL)"
        filter="url(#Linux_svg__n)"
      />
      <ellipse
        transform="matrix(1.09562 0 -.17018 1.51813 -136.244 -82.117)"
        cx={243.297}
        cy={158.284}
        rx={2.608}
        ry={2.328}
        fill="url(#Linux_svg__AM)"
        filter="url(#Linux_svg__o)"
      />
      <path
        ...
        clipPath="url(#Linux_svg__h)"
        fill="url(#Linux_svg__AN)"
      />
    </g>
    <path
      d="M23.115 16.01c.652.524 1.065 1.316 1.193 2.142.1.645.035 1.306-.11 1.942s-.37 1.251-.593 1.864c-.089.245-.178.491-.213.75s-.013.53.111.758c.143.262.409.443.695.528.282.084.587.082.872.01s.553-.21.785-.39c.591-.46.948-1.173 1.086-1.908s.074-1.495-.054-2.231a15.033 15.033 0 0 0-.844-2.936c-.276-.698-.598-1.384-1.049-1.984-.44-.587-.996-1.081-1.428-1.675-.3-.412-.541-.873-.9-1.234-.18-.181-.39-.336-.629-.428s-.504-.12-.75-.05c-.323.09-.589.345-.729.65s-.165.657-.11.988c.07.428.266.826.487 1.2.25.42.538.827.914 1.14.393.328.868.543 1.266.864z"
      className="Linux_svg__E"
    />
    <path
      transform="matrix(.10905 0 0 .10711 -10.129 -8.14)"
      clipPath="url(#Linux_svg__f)"
      d="m290.78 216.018 1.5 1.375c3.667 3.055 5.62 6.485 9.338 9.477 6.085 4.895 12.26 13.344 13.454 21.06.932 6.02-.3 9.29-1.805 16.388s-5.77 17.148-8.074 23.992c-.92 2.73 1.86 1.603 1.496 4.48a17.72 17.72 0 0 0-.035 4.259l.07-.822c.443-3.923 1.623-7.695 2.91-11.395 2.474-7.122 5.314-14.1 7.272-21.408s1.74-12.564.72-18.844c-1.285-7.896-5.797-15.187-12.187-20-4.52-3.403-9.847-5.585-14.656-8.562z"
      fill="#838384"
      filter="url(#Linux_svg__g)"
    />
    <path
      ...
      transform="matrix(.12364 0 0 .10711 18.962 -8.14)"
      opacity={0.25}
      fill="url(#Linux_svg__AO)"
      filter="url(#Linux_svg__e)"
    />
    <path
    ...
    <path
      ...
      fill="url(#Linux_svg__AT)"
      filter="url(#Linux_svg__Y)"
      transform="matrix(.10711 0 0 .10711 18.284 -8.14)"
    />
    <g className="Linux_svg__J">
      <path
        ...
        transform="matrix(-.01028 -.1025 -.08299 .0127 43.874 50.945)"
        opacity={0.75}
        filter="url(#Linux_svg__R)"
      />
      <path
        transform="matrix(-.00749 .1025 -.06047 -.0127 26.485 -21.21)"
        d="M351.96 200.857c-1.452.39-1.23 3.994-.296 5.498.79 1.27 3.072 2.27 3.76 1.005 1.114-2.056-1.472-7.036-3.462-6.503z"
        opacity={0.25}
        filter="url(#Linux_svg__Q)"
      />
    </g>
    <g transform="matrix(.10711 0 0 .10711 18.284 -8.14)">
      <use
        xlinkHref="#Linux_svg__Aa"
        opacity={0.35}
        fill="url(#Linux_svg__AU)"
        filter="url(#Linux_svg__O)"
      />
      <use
        xlinkHref="#Linux_svg__Aa"
        transform="matrix(1 0 0 .72293 0 80.758)"
        opacity={0.35}
        fill="url(#Linux_svg__AV)"
        filter="url(#Linux_svg__P)"
      />
      <path
      ...
      <g transform="translate(-310)">
        <use
          xlinkHref="#Linux_svg__Ab"
          clipPath="url(#Linux_svg__L)"
          fill="url(#Linux_svg__AW)"
          filter="url(#Linux_svg__M)"
        />
        <use
          xlinkHref="#Linux_svg__Ab"
          clipPath="url(#Linux_svg__N)"
          fill="url(#Linux_svg__AX)"
          filter="url(#Linux_svg__M)"
        />
      </g>
    </g>
    <path
      d="m11.696 11.615-1.812 2.27c-.379.469-.766.941-1.013 1.492-.211.472-.311.986-.456 1.483-.165.565-.389 1.11-.64 1.643-.232.49-.487.97-.743 1.45-.186.348-.376.705-.44 1.094-.051.308-.022.626.057.929s.203.59.347.868c.607 1.186 1.518 2.209 2.596 2.991a9.13 9.13 0 0 0 1.564.913c.298.136.613.258.94.264.164.002.33-.025.48-.09s.283-.172.372-.31c.11-.169.147-.379.125-.579s-.1-.391-.205-.563c-.257-.42-.66-.724-1.049-1.026a35.103 35.103 0 0 1-2.43-2.06c-.22-.205-.439-.416-.592-.674a2.522 2.522 0 0 1-.285-.824c-.15-.787-.111-1.615.157-2.37.105-.296.243-.578.377-.862.231-.491.45-.992.755-1.442.379-.56.885-1.035 1.194-1.637.26-.507.366-1.078.467-1.64l.234-1.32z"
      className="Linux_svg__E"
    />
    <path
      d="M232.33 224.27a33 33 0 0 0-5.953 7.318c-2.668 4.46-4.24 9.468-6.178 14.29-1.444 3.59-3.125 7.193-3.327 11.056-.103 1.984.19 3.966.257 5.952s-.118 4.05-1.1 5.784a7 7 0 0 1-3.733 3.144 11.07 11.07 0 0 1 5.335 3.865c1.115 1.5 1.828 3.254 2.796 4.85.787 1.298 1.753 2.5 2.943 3.445s2.61 1.62 4.117 1.813a7.26 7.26 0 0 0 5.765-1.842 135.289 135.289 0 0 1 5.15-53.8c.335-1.095.687-2.198.77-3.34s-.13-2.348-.824-3.258a3.53 3.53 0 0 0-4.9-.69c-.49.364-.882.857-1.127 1.415z"
      clipPath="url(#Linux_svg__J)"
      transform="matrix(.10711 0 0 .10711 -14.921 -8.14)"
      opacity={0.95}
      filter="url(#Linux_svg__K)"
      className="Linux_svg__J"
    ...
    >
      ...
      <path
        ...
        transform="matrix(1 0 0 .98205 0 3.959)"
        fill="#f5bd0c"
        filter="url(#Linux_svg__H)"
      />
      <path
